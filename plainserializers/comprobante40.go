...
type Comprobante40 struct {
	...
	SubTotal          string                `xml:"SubTotal,attr" bson:"SubTotal" json:"SubTotal"`
	Descuento         *string               `xml:"Descuento,attr" bson:"Descuento,omitempty" json:"Descuento,omitempty"`
	Moneda            string                `xml:"Moneda,attr" bson:"Moneda" json:"Moneda"`
	TipoCambio        *string               `xml:"TipoCambio,attr" bson:"TipoCambio,omitempty" json:"TipoCambio,omitempty"`
	Total             string                `xml:"Total,attr" bson:"Total" json:"Total"`
	...
	CfdiRelacionados  *[]CfdiRelacionados40 `xml:"CfdiRelacionados" bson:"CfdisRelacionados,omitempty" json:"CfdisRelacionados,omitempty"`
	Emisor            Emisor40              `xml:"Emisor" bson:"Emisor" json:"Emisor"`
	Receptor          Receptor40            `xml:"Receptor" bson:"Receptor" json:"Receptor"`
	Conceptos         Conceptos40           `xml:"Conceptos" bson:"Conceptos" json:"Conceptos"`
	Impuestos         *Impuestos40          `xml:"Impuestos" bson:"Impuestos,omitempty" json:"Impuestos,omitempty"`
	Complemento       *Complemento40        `xml:"Complemento" bson:"Complemento" json:"Complemento"`
	Addenda           *Addenda40            `xml:"Addenda" bson:"Addenda,omitempty" json:"Addenda,omitempty"`
}
...
type CfdiRelacionados40 struct {
	...
	CfdiRelacionado []CfdiRelacionado40 `xml:"CfdiRelacionado" bson:"UuidsRelacionados" json:"UuidsRelacionados"`
}
...
type Conceptos40 struct {
	Concepto []Concepto40 `xml:"Concepto" json:"Concepto" bson:"Concepto"`
}
...
type Concepto40 struct {
	...
	ValorUnitario       string                   `xml:"ValorUnitario,attr" bson:"ValorUnitario" json:"ValorUnitario"`
	...
	ComplementoConcepto *ComplementoConcepto40   `xml:"ComplementoConcepto" bson:"ComplementoConcepto,omitempty" json:"ComplementoConcepto,omitempty"`
	Parte               *[]Parte40               `xml:"Parte" bson:"Parte,omitempty" json:"Parte,omitempty"`
}

type ImpuestosConcepto40 struct {
	Traslados   *[]TrasladosConcepto40   `xml:"Traslados" bson:"Traslados,omitempty" json:"Traslados,omitempty"`
	Retenciones *[]RetencionesConcepto40 `xml:"Retenciones" bson:"Retenciones,omitempty" json:"Retenciones,omitempty"`
}

type TrasladosConcepto40 struct {
	Traslado []TrasladoConcepto40 `xml:"Traslado" bson:"Traslado,omitempty" json:"Traslado,omitempty"`
}
...
type TrasladoConcepto40 struct {
	...
	TasaOCuota *string `xml:"TasaOCuota,attr" bson:"TasaOCuota,omitempty" json:"TasaOCuota,omitempty"`
	Importe    *string `xml:"Importe,attr" bson:"Importe,omitempty" json:"Importe,omitempty"`
}

type RetencionesConcepto40 struct {
	Retencion []RetencionConcepto40 `xml:"Retencion" bson:"Retencion,omitempty" json:"Retencion,omitempty"`
}
...
type RetencionConcepto40 struct {
	...
	Impuesto   string `xml:"Impuesto,attr" bson:"Impuesto" json:"Impuesto"`
	TipoFactor string `xml:"TipoFactor,attr" bson:"TipoFactor" json:"TipoFactor"`
	TasaOCuota string `xml:"TasaOCuota,attr" bson:"TasaOCuota" json:"TasaOCuota"`
	Importe    string `xml:"Importe,attr" bson:"Importe" json:"Importe"`
}
...
type ComplementoConcepto40 struct {
}

type Impuestos40 struct {
	Traslados   *[]Traslados40   `xml:"Traslados" bson:"Traslados,omitempty" json:"Traslados,omitempty"`
	Retenciones *[]Retenciones40 `xml:"Retenciones" bson:"Retenciones,omitempty" json:"Retenciones,omitempty"`
}

type Traslados40 struct {
	Traslado []Traslado40 `xml:"Traslado" bson:"Traslado,omitempty" json:"Traslado,omitempty"`
}

type Traslado40 struct {
	Base       string  `xml:"Base,attr" bson:"Base" json:"Base"`
	Impuesto   string  `xml:"Impuesto,attr" bson:"Impuesto" json:"Impuesto"`
	TipoFactor string  `xml:"TipoFactor,attr" bson:"TipoFactor" json:"TipoFactor"`
	TasaOCuota *string `xml:"TasaOCuota,attr" bson:"TasaOCuota,omitempty" json:"TasaOCuota,omitempty"`
...
type Retenciones40 struct {
	Retencion []Retencion40 `xml:"Retencion" bson:"Retencion,omitempty" json:"Retencion,omitempty"`
}

type Retencion40 struct {
	Impuesto string `xml:"Impuesto,attr" bson:"Impuesto" json:"Impuesto"`
	Importe  string `xml:"Importe,attr" bson:"Importe" json:"Importe"`
}

type Complemento40 struct {
	TimbreFiscalDigital *TimbreFiscalDigital11 `xml:"TimbreFiscalDigital" bson:"TimbreFiscalDigital,omitempty" json:"TimbreFiscalDigital,omitempty"`
}

type Addenda40 struct {
}
